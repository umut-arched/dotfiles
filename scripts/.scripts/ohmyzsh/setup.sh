...
setup_color() {
  ...
  if supports_truecolor; then
    FMT_RAINBOW="
      $(printf '[38;2;255;0;0m')
      $(printf '[38;2;255;97;0m')
      $(printf '[38;2;247;255;0m')
      $(printf '[38;2;0;255;30m')
      $(printf '[38;2;77;0;255m')
      $(printf '[38;2;168;0;255m')
      $(printf '[38;2;245;0;172m')
    "
  else
    FMT_RAINBOW="
      $(printf '[38;5;196m')
  ...
  FMT_RED=$(printf '[31m')
  FMT_GREEN=$(printf '[32m')
  FMT_YELLOW=$(printf '[33m')
  FMT_BLUE=$(printf '[34m')
  FMT_BOLD=$(printf '[1m')
  FMT_RESET=$(printf '[0m')
}
